...
|---|---|---|---|
| ★ P0 | 근로소득공제 | 별도 계산 슬라이스 | 구현 완료 (commit 169f77f) |
| ★ P0 | 실제 종합소득 과세표준 세율표 | 별도 계산 슬라이스 | 구현 완료 (commit 1bbc1fc) |
| ★ P0 | 근로소득세액공제 | 별도 계산 슬라이스 | 구현 완료 (commit 1bbc1fc) |
| ★ P0 | 인적공제 | 공제 슬라이스 가능 | 구현 완료 (commit cd90e4d) |
| ★ P0 | 연금보험료공제 | 공제 슬라이스 가능 | 구현 완료 (commit 9b1b055) |
| ★ P0 | 특별소득공제 중 사회보험료 | 공제 슬라이스 가능 | 구현 완료 (commit ce7782e) |
...
|---|---|---|---|---|
| ★ P1 | 신용카드 등 사용금액 소득공제 | 구현 완료 | `4-1 -> 4-2 -> 4-3` | commit 953b6cf |
| ★ P1 | 기부금 세액공제 | 구현 완료 | `4-1 -> 4-2 -> 4-3` | commit 0add719 |
| ★ P1 | 보험료 세액공제 확장 | 구현 완료 | `4-1 -> 4-2 -> 3-4 또는 4-3` | commit 5b1b678 |
| ★ P1 | 의료비 세액공제 확장 | 구현 완료 | `4-1 -> 4-2 -> 3-4 또는 4-3` | commit f877c30 |
| ★ P1 | 교육비 세액공제 확장 | 구현 완료 | `4-1 -> 4-2 -> 3-4 또는 4-3` | commit e20f208 |
...
| ★ P3 감면 | 중소기업 취업자 소득세 감면 | 구현 완료 | `4-1 -> 4-2 -> 4-3` | commit 3f36fd2 |
...
| 우선순위 | 후보 | 처리 방식 | 비고 |
|---|---|---|---|
| ★ P3 | 중소기업 취업자 소득세 감면 | 구현 완료 (조세특례제한법 제30조) | commit 3f36fd2 |
