...
| P2 | 자녀세액공제 | 미구현 | `4-1 -> 4-2 -> 4-3` | 부양가족 정보와 강하게 연결 |
| P2 | 연금계좌 세액공제 | 미구현 | `4-1 -> 4-2 -> 4-3` | 연금저축, 퇴직연금, IRP, ISA 만기 전환 관련 항목 |
| P2 | 월세액 세액공제 | 미구현 | `4-1 -> 4-2 -> 4-3` | 주택/세대주/총급여 요건과 증빙 검증 필요 |
| P2 | 주택임차차입금 원리금상환액 공제 | 미구현 | `4-1 -> 4-2 -> 4-3` | 주택자금 공제 계열 |
| P2 | 장기주택저당차입금 이자상환액 공제 | 미구현 | `4-1 -> 4-2 -> 4-3` | 주택자금 공제 계열 |
| P2 | 주택마련저축/청약저축 소득공제 | 미구현 | `4-1 -> 4-2 -> 4-3` | 무주택/세대주 요건 검증 필요 |
| P3 | 소기업·소상공인 공제부금 | 미구현 | `4-1 -> 4-2 -> 4-3` | 대상자는 제한적이나 신고서 항목에 포함 |
| P3 | 투자조합 출자 등 투자 관련 공제 | 미구현 | `4-1 -> 4-2 -> 4-3` | 투자 유형별 한도와 증빙 분리 필요 |
| P3 | 우리사주조합 출연금 | 미구현 | `4-1 -> 4-2 -> 4-3` | 회사/조합 자료 연계 가능성 확인 필요 |
| P3 | 장기집합투자증권저축 | 미구현 | `4-1 -> 4-2 -> 4-3` | 금융기관 자료 기반 |
| P3 | 청년형 장기집합투자증권저축 | 미구현 | `4-1 -> 4-2 -> 4-3` | 나이/소득 요건 검증 필요 |
| P3 | 외국납부세액공제 | 미구현 | `4-1 -> 4-2 -> 4-3` | 특수 케이스, 증빙과 환율 기준 확인 필요 |
| P3 | 납세조합공제 | 미구현 | `4-1 -> 4-2 -> 4-3` | 특수 케이스 |
| P3 | 표준세액공제 | 미구현 | `4-1 -> 4-2 -> 4-3` | 특별세액공제와의 선택/대체 관계 확인 필요 |
